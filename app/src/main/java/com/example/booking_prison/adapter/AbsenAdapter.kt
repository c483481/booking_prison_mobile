...
class AbsenAdapter(private val items: Array<AbsenResponse>, private  val listener: OnClickAdapter<AbsenResponse>): RecyclerView.Adapter<AbsenAdapter.ViewHolder>() {
